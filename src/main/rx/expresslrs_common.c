...
elrs_mod_settings_t air_rate_config[][ELRS_RATE_MAX] = {
#ifdef USE_RX_SX127X
    {
        ...
        {3, RATE_25HZ, SX127x_BW_500_00_KHZ, SX127x_SF_9, SX127x_CR_4_7, 40000, TLM_RATIO_NO_TLM, 2, 10, -123, MS_TO_US(6000)}
    },
#endif
#ifdef USE_RX_SX1280
    {
        ...
        {3, RATE_50HZ, SX1280_LORA_BW_0800, SX1280_LORA_SF9, SX1280_LORA_CR_LI_4_6, 20000, TLM_RATIO_NO_TLM, 2, 12, -117, MS_TO_US(4000)}
    },
#endif
